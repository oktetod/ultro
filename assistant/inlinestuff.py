...
ofox = "https://telegra.ph/file/ca5c07f5566431e1e6152.jpg"
gugirl = "https://telegra.ph/file/ca5c07f5566431e1e6152.jpg"
ultpic = "https://telegra.ph/file/ca5c07f5566431e1e6152.jpg"
...
async def repo(e):
    ...
    await e.answer(res, switch_pm="BayUserBot Repo.", switch_pm_param="start")
...
async def piston_run(event):
    try:
        ...
        result = await event.builder.article(
            ...
            thumb=wb(
                "https://telegra.ph/file/ca5c07f5566431e1e6152.jpg", 0, "image/jpeg", []
            ),
    ...
    for count, feed in enumerate(se_[:10]):
        if feed["uiItemType"] == "search_profile":
            ...
            profileImage = (
                ...
                else "https://telegra.ph/file/ca5c07f5566431e1e6152.jpg"
            )
